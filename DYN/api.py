    ...
    def iterator(
        ...
        for _ in itertools.count() if repeat else [0]:
            for i, batch in enumerate(loader):
                ...
                domain = [idx // dataset_pic_per_class + 1 for idx in batch_indices]
                Dm=domain
                ...
                print('------------------------------------------------------------------------------------------\n')
                print('\n------------------------------------batch data Preview------------------------------------')
                print(f"batch Domain{step}", [idx // dataset_pic_per_class + 1 for idx in batch_indices])
                ...
                print('------------------------------------------------------------------------------------------\n')
                print('\n-------------------------------------Runtime Preview--------------------------------------')
                yield step, epoch_fractional, self._prepare_batch(batch, self._device),domain
